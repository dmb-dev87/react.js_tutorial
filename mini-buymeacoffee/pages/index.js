...
import abi from "../abis/CoffeePortal.json";

export default function Home() {

  const contractAddress = "0x25480521E33a75dB1298d579B0A7ED4ceD032CeD";
  ...
  const getAllCoffee = async () => {
    try {
      ...
      if (ethereum) {
        ...
        console.log("Ethereum object doen't exist!");
      }
    } catch (error) {
      console.log(error);
    }
        ...
        {currentAccount ? (
          ...
          <div>
            <p className="text-2xl text-blue-600 mb-6">
              You can switch your wallet to Rinkeby Testnet Network to test this application.
            </p>
            <button
